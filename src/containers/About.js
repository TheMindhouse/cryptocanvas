  ...
  <div>
    ...
    <Row className="container About">
      ...
      <Col span={16}>
        ...
        <p>A canvas is being painted while as long as there is still at least one pixel without a color. You can place a
        ...
        <p>To determine its first owner, the canvas is put up for an auction. Other users willing to make a bid will
          have only 48 hours to do so. After this time, a bidder with the last, highest bid becomes the sole owner of
          the canvas. Amount of Ether from the bid is evenly distributed to all the authors of the canvas, based on how
          many pixels appearing on the completed artwork they placed. The more pixels were placed by you on the final
          canvas, the bigger will be your reward!</p>
